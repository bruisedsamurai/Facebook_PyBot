...
class Send:
    ...
    def send_attachment(self, user_id: Union[str,int], attachment_type: str, url: str, file, notification_type: str = 'REGULAR',
    ...
    def send_button_template(self, user_id: Union[str,int], text: str, button_1: Dict[str, Any], button_2: Dict[str, Any] = None,
                             button_3: Dict[str, Any] = None, quick_replies: Dict[str, Any] = None) -> Optional[
        Dict[str, Any]]:
        ...

    def send_generic_template(self, user_id: Union[str,int], elements: List[Dict[str, Any]], quick_replies: Dict[str, Any] = None) -> \
            Optional[Dict[str, Any]]:
        ...

    def send_list_template(self, user_id: Union[str,int], elements: List[Dict[str, Any]], top_element_style: str = "large",
                           quick_replies: Dict[str, Any] = None) -> Optional[Dict[str, Any]]:
        ...
